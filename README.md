...
Je suis un développeur front-end passionné par la création de technologies pour rond les choses plus faciles. certaines technologies avec lesquelles j'aime travailler est javascript, react js, html, css, scss
